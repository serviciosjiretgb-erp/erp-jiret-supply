...
export default function App() {
  ...
  // ============================================================================
  // LOGICA PRODUCCIÓN (REPARADA CONTRA FALLOS)
  // ============================================================================
  ...
  const handleDeleteBatch = async (reqId, phase, batchId) => {
    setDialog({ title: `ELIMINAR LOTE`, text: `¿Seguro que desea eliminar este lote parcial?`, type: 'confirm', onConfirm: async () => {
        ...
        if (bIdx >= 0) { 
          ...
          for (let ing of (batch.insumos || [])) { const item = (inventory || []).find(i => i.id === ing.id); if (item) fbBatch.update(getDocRef('inventory', item.id), { stock: item.stock + ing.qty }); } 
                     ...
                     <table className="w-full text-left text-[10px] whitespace-nowrap print-text-xs text-black">
                        ...
                        <tbody className="text-black divide-y divide-gray-200 print:divide-black">
                           <tr className="bg-gray-100 font-black">
                             <td className="p-2 pl-4">MEZCLA PROCESADA</td>
                             <td className="p-2 text-center">{formatNum(calcTotalMezcla)}</td>
                             <td className="p-2 text-center">kg</td>
                             <td className="p-2">Entrada Planta</td>
                           </tr>
                           <tr className="bg-green-50 font-black text-green-800">
                             ...
                             <td className="p-2">Rendimiento estimado</td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
        ...
        <div className="overflow-hidden rounded-xl border border-gray-300">
           <table className="w-full text-left text-[10px] whitespace-nowrap">
              ...
              <tbody className="divide-y divide-gray-200">
                 ...
                 <tr><td colSpan="4" className="p-2 font-black uppercase text-[11px] text-orange-600 bg-orange-50">1. MATERIA PRIMA CONSUMIDA</td></tr>
                 ...
                 <tr><td colSpan="4" className="p-2 pt-4 font-black uppercase text-[11px] text-orange-600 bg-orange-50">2. RESULTADO FINAL</td></tr>
